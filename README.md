<div align="center">
  <br>
  <a href="https://jailbreak.party/discord"><img src="https://github.com/jailbreakdotparty/Lithium/blob/main/LithiumAppIcon.png?raw=true" alt="SparseBoxPlus Icon" width="150"></a>
  <br>
  <h1>Lithium</h1>
  <p>A very basic and limited customization tool that uses only MDM configuration profiles.</a></p>
...
- Webclip Generator: Allows you to add a webpage to your homescreen as if it was an app.
